...
cookiecutter --checkout $GITHUB_BRANCH \
             ...
             global_platform_name=coursery \
             global_platform_region=global \
             global_aws_region=ap-south-1 \
             global_account_id=751448075284 \
             global_root_domain=coursery.co \
             global_aws_route53_hosted_zone_id=Z06945481BRC8RGN661JZ \
             environment_name=prod \
             environment_subdomain=education \
